<template>
    <div class="w-full overflow-hidden">
        ...
        <a href="tel:+99361626364"
            ...
            <phone-icon />
            <span
                class="absolute right-full bottom-2 mr-3 bg-gray-900 text-white px-3 py-2 rounded-lg sm:text-sm text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">+99361626364</span>
        </a>
    </div>
